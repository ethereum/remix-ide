...
export class MainView {
  constructor (editor, mainPanel, fileManager, appManager, txListener, eventsDecoder, executionContext, remixdGit) {
    var self = this
