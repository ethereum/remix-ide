...
# Team communication
 ...
 - A "preparation for release" standup - scheduled before planning for a new release, define what will be included in the **next release** and who will work on what. This standup also help to set a clear long term vision.
...
- Updates of the documentation should be done together with the story, or an issue with the label "documentation" has to be created.
...
# Projects Release
 ...
 - A new release is trigerred when all the issues / PR of the corresponding projects are addressed.
 ...
 - A release project duration is fixed at the start of the milestone (but should better not exceed 1 month).
 - Progress and issues regarding are discussed on regular standups.
...
# Releases
 ...
 - A new release is triggered:
    ...
    - at the end of a project release
